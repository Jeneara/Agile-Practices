...
describe('TicTacToe should', () => {
  ...
  test('the second player is player o', () => {
    const ticTacToe = new TicTacToe();
    ticTacToe.play(1);
    const play = ticTacToe.play(2);
    expect(play).toBe('O');
  });

  test('Players cannot play on last played square', () => {
    const ticTacToe = new TicTacToe();
    ticTacToe.play(1);
    expect(() => ticTacToe.play(1)).toThrow('Play invalid');
  });

  test('Players cannot play on any played square', () => {
    const ticTacToe = new TicTacToe();
    ticTacToe.play(1);
    ticTacToe.play(2);
    expect(() => ticTacToe.play(1)).toThrow('Play invalid');
  ...
  //   ticTacToe.play(2);
  //   ticTacToe.play(5);
  //   expect(ticTacToe.play(3)).toBe('Player X Wins!');
  // });

  // const ticTacToe = new TicTacToe();
  // expect(ticTacToe.play()).toStrictEqual([
  //   [null, 'X', null],
  //   [null, null, null],
  //   [null, null, null],
  // ]);
